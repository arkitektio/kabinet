...
from typing import List, Any, Iterable, Annotated, Union, Tuple, Literal, Optional, Dict
from enum import Enum
from datetime import datetime
from kabinet.funcs import aexecute, execute
from kabinet.scalars import JSONSerializable, SearchQuery, ValidatorFunction, ActionHash
...
class ActionDependencyInput(BaseModel):
    ...
    allow_inactive: Annotated[Optional[bool], GraphQLDefault("True")] = Field(
        alias="allowInactive", default=None
    )
    "Default: True"
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
...
class AgentDependencyInput(BaseModel):
    ...
    auto_resolvable: Annotated[Optional[bool], GraphQLDefault("False")] = Field(
        alias="autoResolvable", default=None
    )
    "Default: False"
...
class AssignWidgetInput(BaseModel):
    ...
    dependencies: Annotated[Optional[Tuple[str, ...]], GraphQLDefault("[]")] = None
    "Default: []"
...
class BackendFilter(BaseModel):
    ...
    ids: Optional[Tuple[ID, ...]] = Field(
        default=None, description="Keep only backends whose ID is in this list."
    )
    search: Optional[str] = Field(
        default=None, description="Case-insensitive search on the backend name."
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class CreateDeploymentInput(BaseModel):
    ...
    local_id: ID = Field(
        alias="localId",
        description="The identifier of the deployment as known to the backend.",
    )
    flavour: ID = Field(description="The ID of the flavour to deploy.")
    last_pulled: Optional[datetime] = Field(
        alias="lastPulled",
        default=None,
        description="When the flavour's image was last pulled, if known.",
    )
    secret_params: Optional[Any] = Field(
        alias="secretParams",
        default=None,
        description="Secret parameters passed to the deployment (e.g. credentials).",
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class CreateGithubRepoInput(BaseModel):
    ...
    name: Optional[str] = Field(
        default=None, description="An optional human-readable name for the repository."
    )
    ...
    branch: Optional[str] = Field(
        default=None, description="The branch to scan for app manifests."
    )
    repo: Optional[str] = Field(
        default=None, description="The repository name on GitHub."
    )
    identifier: Optional[str] = Field(
        default=None,
        description="An optional identifier (e.g. 'user/repo') used to derive the other fields.",
    )
    auto_scan: Annotated[Optional[bool], GraphQLDefault("True")] = Field(
        alias="autoScan",
        default=None,
        description="Whether to scan the repository immediately after adding it.",
    )
...
class CreatePodInput(BaseModel):
    ...
    deployment: ID = Field(
        description="The ID of the deployment this pod is an instance of."
    )
    local_id: ID = Field(
        alias="localId",
        description="The identifier of the pod as known to the backend.",
    )
    resource: Optional[ID] = Field(
        default=None, description="The resource this pod is scheduled onto, if any."
    )
    client_id: Optional[str] = Field(
        alias="clientId",
        default=None,
        description="The OAuth2 client ID this pod authenticates as, if any.",
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class DeclareResourceInput(BaseModel):
    ...
    name: Optional[str] = Field(
        default=None, description="An optional human-readable name for the resource."
    )
    local_id: str = Field(
        alias="localId",
        description="The identifier of the resource as known to the backend.",
    )
    qualifiers: Optional[Tuple["QualifierInput", ...]] = Field(
        default=None,
        description="Free-form key/value qualifiers describing the resource.",
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class DeviceFeature(BaseModel):
    ...
    cpu_count: str = Field(
        alias="cpuCount", description="The number of CPUs the feature describes."
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class EffectInput(BaseModel):
    ...
    kind: EffectKind
    fade: Annotated[Optional[bool], GraphQLDefault("True")] = None
    "Default: True"
    hook: Optional[str] = None
    ward: Optional[str] = None
    model_config = ConfigDict(
...
class EnvironmentInput(BaseModel):
    ...
    container_type: ContainerType = Field(
        alias="containerType",
        description="The container runtime available in the environment.",
    )
    features: Optional[Tuple[DeviceFeature, ...]] = Field(
        default=None, description="The hardware features available in the environment."
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class FlavourFilter(BaseModel):
    ...
    distinct: Optional[bool] = Field(alias="DISTINCT", default=None)
    ids: Optional[Tuple[ID, ...]] = Field(
        default=None, description="Keep only flavours whose ID is in this list."
    )
    search: Optional[str] = Field(
        default=None, description="Case-insensitive search on the flavour name."
    )
    has_definitions: Optional[Tuple[ID, ...]] = Field(
        alias="hasDefinitions",
        default=None,
        description="Keep only flavours that provide one of the given definitions.",
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class ImplementationInput(BaseModel):
    ...
    dynamic: Annotated[Optional[bool], GraphQLDefault("False")] = None
    "Default: False"
...
class InspectionInput(BaseModel):
    ...
    bloks: Annotated[
        Optional[Tuple[BlokImplementationInput, ...]], GraphQLDefault("[]")
    ] = None
    "Default: []"
...
class ManifestInput(BaseModel):
    ...
    entrypoint: Optional[str] = Field(
        default=None, description="The entrypoint of the app, defaults to 'app'"
    )
    identifier: str
    version: str
...
class ResourceFilter(BaseModel):
    ...
    distinct: Optional[bool] = Field(alias="DISTINCT", default=None)
    ids: Optional[Tuple[ID, ...]] = Field(
        default=None, description="Keep only resources whose ID is in this list."
    )
    search: Optional[str] = Field(
        default=None, description="Case-insensitive search on the resource name."
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class SelectorInput(BaseModel):
    ...
    kind: str = Field(
        description="The discriminator identifying which kind of selector this is (e.g. 'cuda', 'rocm', 'cpu', 'oneapi')."
    )
    api_version: Optional[str] = Field(
        alias="apiVersion",
        default=None,
        description="The minimum ROCm API version required (rocm selectors).",
    )
    api_thing: Optional[str] = Field(
        alias="apiThing",
        default=None,
        description="An additional ROCm capability qualifier (rocm selectors).",
    )
    oneapi_version: Optional[str] = Field(
        alias="oneapiVersion",
        default=None,
        description="The minimum oneAPI version required (oneapi selectors).",
    )
    cuda_cores: Optional[int] = Field(
        alias="cudaCores",
        default=None,
        description="The minimum number of CUDA cores required (cuda selectors).",
    )
    frequency: Optional[int] = Field(
        default=None,
        description="The minimum CPU frequency required, in MHz (cpu selectors).",
    )
    memory: Optional[int] = Field(
        default=None, description="The minimum memory required, in MB (cpu selectors)."
    )
    model_config = ConfigDict(
        frozen=True, extra="forbid", populate_by_name=True, use_enum_values=True
    )
...
class UpdatePodInput(BaseModel):
    ...
    pod: Optional[ID] = Field(
        default=None,
        description="The ID of the pod to update; required unless 'local_id' is given.",
    )
    local_id: Optional[ID] = Field(
        alias="localId",
        default=None,
        description="The backend-local identifier of the pod to update.",
    )
...
def action_argument_input(
    key: Union[Optional[str], UnsetType] = UNSET,
    value_literal: Union[Optional[JSONSerializable], UnsetType] = UNSET,
    value_path: Union[Optional[str], UnsetType] = UNSET,
    agent_call: Union[Optional[AgentCallInput], UnsetType] = UNSET,
    util_call: Union[Optional[UtilCallInput], UnsetType] = UNSET,
    value_list: Union[Optional[Iterable[ActionArgumentInput]], UnsetType] = UNSET,
    value_dict: Union[Optional[Iterable[ActionArgumentInput]], UnsetType] = UNSET,
) -> ActionArgumentInput:
    """Creates a ActionArgumentInput

    Arguments:
        key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        value_literal: The `JSONSerializable` scalar type represents a JSON-serializable value.
        value_path: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        agent_call: Defines a callback that routes user interactions directly to an Arkitekt Agent via Rekuest.
        util_call: Defines a utility call that can be invoked within the system.
        value_list: A JSON-serializable argument entry for a multi-agent action trigger. (required) (list)
        value_dict: A JSON-serializable argument entry for a multi-agent action trigger. (required) (list)
    """
    data: Dict[str, Any] = {}
    if key is not UNSET:
        data["key"] = key
...
def action_dependency_input(
    key: str,
    optional: bool,
    name: Union[Optional[str], UnsetType] = UNSET,
    description: Union[Optional[str], UnsetType] = UNSET,
    action_key: Union[Optional[str], UnsetType] = UNSET,
    app: Union[Optional[str], UnsetType] = UNSET,
    arg_matches: Union[Optional[Iterable[PortMatchInput]], UnsetType] = UNSET,
    return_matches: Union[Optional[Iterable[PortMatchInput]], UnsetType] = UNSET,
    protocols: Union[Optional[Iterable[IDCoercible]], UnsetType] = UNSET,
    force_arg_length: Union[Optional[int], UnsetType] = UNSET,
    force_return_length: Union[Optional[int], UnsetType] = UNSET,
    allow_inactive: Union[Optional[bool], UnsetType] = UNSET,
    ...
    Arguments:
        ...
        action_key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        app: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        arg_matches: A dependency for a implementation. By defining dependencies, you can
        create a dependency graph for your implementations and actions (required) (list)
        return_matches: A dependency for a implementation. By defining dependencies, you can
        create a dependency graph for your implementations and actions (required) (list)
        ...
        force_arg_length: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
        force_return_length: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
        optional: The `Boolean` scalar type represents `true` or `false`. (required)
        allow_inactive: The `Boolean` scalar type represents `true` or `false`.
    """
    data: Dict[str, Any] = {}
...
def agent_call_input(
    dependency: str,
    operation: str,
    arguments: Union[Optional[Iterable[ActionArgumentInput]], UnsetType] = UNSET,
) -> AgentCallInput:
    """Creates a AgentCallInput

    Arguments:
        dependency: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        operation: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        arguments: A JSON-serializable argument entry for a multi-agent action trigger. (required) (list)
    """
    data: Dict[str, Any] = {}
...
def agent_dependency_input(
    key: str,
    optional: bool,
    auto_resolvable: bool,
    name: Union[Optional[str], UnsetType] = UNSET,
    mutually_exclusive_keys: Union[Optional[Iterable[str]], UnsetType] = UNSET,
    app: Union[Optional[str], UnsetType] = UNSET,
    version: Union[Optional[str], UnsetType] = UNSET,
    description: Union[Optional[str], UnsetType] = UNSET,
    action_demands: Union[Optional[Iterable[ActionDependencyInput]], UnsetType] = UNSET,
    state_demands: Union[Optional[Iterable[StateDependencyInput]], UnsetType] = UNSET,
    min_viable_instances: Union[Optional[int], UnsetType] = UNSET,
    max_viable_instances: Union[Optional[int], UnsetType] = UNSET,
    prefered_instances: Union[Optional[int], UnsetType] = UNSET,
    ...
    Arguments:
        ...
        description: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        optional: The `Boolean` scalar type represents `true` or `false`. (required)
        action_demands: A dependency for a implementation. By defining dependencies, you can
        create a dependency graph for your implementations and actions (required) (list)
        state_demands: A dependency for a implementation. By defining dependencies, you can
        create a dependency graph for your implementations and actions (required) (list)
        auto_resolvable: The `Boolean` scalar type represents `true` or `false`. (required)
        min_viable_instances: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
        max_viable_instances: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
        prefered_instances: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
    """
    data: Dict[str, Any] = {}
    if name is not UNSET:
        data["name"] = name
...
def app_image_input(
    ...
    inspection: InspectionInput,
    image: DockerImageInput,
    flavour_name: Union[Optional[str], UnsetType] = UNSET,
) -> AppImageInput:
...
def arg_port_input(
    ...
    kind: PortKind,
    nullable: bool,
    validators: Union[Optional[Iterable[ValidatorInput]], UnsetType] = UNSET,
    label: Union[Optional[str], UnsetType] = UNSET,
    description: Union[Optional[str], UnsetType] = UNSET,
    identifier: Union[Optional[str], UnsetType] = UNSET,
    effects: Union[Optional[Iterable[EffectInput]], UnsetType] = UNSET,
    default: Union[Optional[Any], UnsetType] = UNSET,
    choices: Union[Optional[Iterable[ChoiceInput]], UnsetType] = UNSET,
    widget: Union[Optional[AssignWidgetInput], UnsetType] = UNSET,
    requires: Union[Optional[Iterable[RequiresInput]], UnsetType] = UNSET,
    children: Union[Optional[Iterable[ArgPortInput]], UnsetType] = UNSET,
) -> ArgPortInput:
    ...
    when transversing the tree of ports.
     ...
     (required) (list)
        ...
        E.g when the user selects a certain option in a dropdown, another port is hidden.
         ...
         (required) (list)
        default: The `ArrayLike` scalar type represents a reference to a store previously created by the user n a datalayer
        choices:
    A choice is a value that can be selected in a dropdown.
...
def assign_widget_input(
    kind: AssignWidgetKind,
    as_paragraph: Union[Optional[bool], UnsetType] = UNSET,
    query: Union[Optional[SearchQuery], UnsetType] = UNSET,
    choices: Union[Optional[Iterable[ChoiceInput]], UnsetType] = UNSET,
    min: Union[Optional[float], UnsetType] = UNSET,
    max: Union[Optional[float], UnsetType] = UNSET,
    step: Union[Optional[float], UnsetType] = UNSET,
    placeholder: Union[Optional[str], UnsetType] = UNSET,
    hook: Union[Optional[str], UnsetType] = UNSET,
    ward: Union[Optional[str], UnsetType] = UNSET,
    fallback: Union[Optional[AssignWidgetInput], UnsetType] = UNSET,
    filters: Union[Optional[Iterable[ArgPortInput]], UnsetType] = UNSET,
    dependencies: Union[Optional[Iterable[str]], UnsetType] = UNSET,
    dependency: Union[Optional[str], UnsetType] = UNSET,
    target_dependency: Union[Optional[str], UnsetType] = UNSET,
    target_action: Union[Optional[str], UnsetType] = UNSET,
    target_port: Union[Optional[str], UnsetType] = UNSET,
    state_path: Union[Optional[str], UnsetType] = UNSET,
    state_accessors: Union[Optional[Iterable[StateAccessorInput]], UnsetType] = UNSET,
) -> AssignWidgetInput:
    ...
    Arguments:
        ...
        kind: AssignWidgetKind (required)
        query: The `ArrayLike` scalar type represents a reference to a store previously created by the user n a datalayer
        choices:
    A choice is a value that can be selected in a dropdown.
    ...
    that is displayed when the user hovers over the choice.
         ...
         (required) (list)
        min: The `Float` scalar type represents signed double-precision fractional values as specified by [IEEE 754](https://en.wikipedia.org/wiki/IEEE_floating_point).
        max: The `Float` scalar type represents signed double-precision fractional values as specified by [IEEE 754](https://en.wikipedia.org/wiki/IEEE_floating_point).
        step: The `Float` scalar type represents signed double-precision fractional values as specified by [IEEE 754](https://en.wikipedia.org/wiki/IEEE_floating_point).
        placeholder: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        hook: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        ward: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        fallback:
        filters: Port
        ...
        documentation for more information on how this works.
         ...
         (required) (list)
        dependencies: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required) (list)
        ...
        target_dependency: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        target_action: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        target_port: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        state_path: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        state_accessors:  (required) (list)
    """
    data: Dict[str, Any] = {}
...
def backend_filter(
    and_: Union[Optional[BackendFilter], UnsetType] = UNSET,
    or_: Union[Optional[BackendFilter], UnsetType] = UNSET,
    not_: Union[Optional[BackendFilter], UnsetType] = UNSET,
...
def blok_implementation_input(
    key: str,
    dependencies: Iterable[AgentDependencyInput],
    components: Iterable[ComponentNodeInput],
    catalog: Union[Optional[str], UnsetType] = UNSET,
    description: Union[Optional[str], UnsetType] = UNSET,
    demo_state: Union[Optional[JSONSerializable], UnsetType] = UNSET,
    ...
    Arguments:
        ...
        components: An abstract structural visual element inside a Blok blueprint manifest. (required) (list) (required)
        ...
        description: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        demo_state: The `JSONSerializable` scalar type represents a JSON-serializable value.
    """
    data: Dict[str, Any] = {}
    data["key"] = key
    data["dependencies"] = dependencies
...
def choice_input(
    value: Any,
    label: str,
    image: Union[Optional[str], UnsetType] = UNSET,
    description: Union[Optional[str], UnsetType] = UNSET,
) -> ChoiceInput:
    ...
    Arguments:
        ...
        image: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        description: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
    """
    data: Dict[str, Any] = {}
    data["value"] = value
...
def component_node_input(
    id: str,
    component: str,
    props: Union[Optional[Iterable[ComponentPropInput]], UnsetType] = UNSET,
    children: Union[Optional[Iterable[ComponentNodeInput]], UnsetType] = UNSET,
) -> ComponentNodeInput:
    """Creates a ComponentNodeInput

    Arguments:
        id: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        component: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        props: A single key-value prop configuration for a component layout node. (required) (list)
        children: An abstract structural visual element inside a Blok blueprint manifest. (required) (list)
    """
    data: Dict[str, Any] = {}
    data["id"] = id
...
def component_prop_input(
    key: str,
    static_value: Union[Optional[JSONSerializable], UnsetType] = UNSET,
    dynamic_value: Union[Optional[DynamicValueInput], UnsetType] = UNSET,
    declares_value: Union[Optional[str], UnsetType] = UNSET,
    agent_call: Union[Optional[AgentCallInput], UnsetType] = UNSET,
    util_call: Union[Optional[UtilCallInput], UnsetType] = UNSET,
) -> ComponentPropInput:
    ...
    Arguments:
        key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        static_value: The `JSONSerializable` scalar type represents a JSON-serializable value.
        dynamic_value: A bound state pointer referencing a variable inside a Blok state instance.
        declares_value: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        agent_call: Defines a callback that routes user interactions directly to an Arkitekt Agent via Rekuest.
        util_call: Defines a utility call that can be invoked within the system.
    """
    data: Dict[str, Any] = {}
...
def create_deployment_input(
    local_id: IDCoercible,
    flavour: IDCoercible,
    last_pulled: Union[Optional[datetime], UnsetType] = UNSET,
    secret_params: Union[Optional[Any], UnsetType] = UNSET,
...
def create_github_repo_input(
    name: Union[Optional[str], UnsetType] = UNSET,
    user: Union[Optional[str], UnsetType] = UNSET,
    branch: Union[Optional[str], UnsetType] = UNSET,
    repo: Union[Optional[str], UnsetType] = UNSET,
    identifier: Union[Optional[str], UnsetType] = UNSET,
    auto_scan: Union[Optional[bool], UnsetType] = UNSET,
...
def create_pod_input(
    deployment: IDCoercible,
    local_id: IDCoercible,
    resource: Union[Optional[IDCoercible], UnsetType] = UNSET,
    client_id: Union[Optional[str], UnsetType] = UNSET,
) -> CreatePodInput:
...
def declare_resource_input(
    backend: IDCoercible,
    local_id: str,
    name: Union[Optional[str], UnsetType] = UNSET,
    qualifiers: Union[Optional[Iterable[QualifierInput]], UnsetType] = UNSET,
...
def definition_input(
    ...
    name: str,
    stateful: bool,
    port_groups: Iterable[PortGroupInput],
    args: Iterable[ArgPortInput],
    returns: Iterable[ReturnPortInput],
    kind: ActionKind,
    is_test_for: Iterable[str],
    interfaces: Iterable[str],
    is_dev: bool,
    description: Union[Optional[str], UnsetType] = UNSET,
    package: Union[Optional[str], UnsetType] = UNSET,
    tests: Union[Optional[ActionDependencyInput], UnsetType] = UNSET,
    logo: Union[Optional[str], UnsetType] = UNSET,
) -> DefinitionInput:
...
def dynamic_value_input(
    path: Union[Optional[str], UnsetType] = UNSET,
) -> DynamicValueInput:
    """Creates a DynamicValueInput

    Arguments:
        path: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
    """
    data: Dict[str, Any] = {}
...
def effect_input(
    ...
    fade: Union[Optional[bool], UnsetType] = UNSET,
    hook: Union[Optional[str], UnsetType] = UNSET,
    ward: Union[Optional[str], UnsetType] = UNSET,
) -> EffectInput:
    ...
    Arguments:
        ...
        The `Validator` scalar represents a javascript function that should execute on the client side (inside a shadow realm)
          to validate a value (or a set of values) before it is sent to the server.  The function has two parameters (value, otherValues) and should return a string if the value is invalid and undefined if the value is valid.
            The otherValues parameter is an object with the other values in the form {fieldName: value}. (required)
        dependencies: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required) (list)
        ...
        fade: The `Boolean` scalar type represents `true` or `false`.
        hook: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        ward: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
    """
    data: Dict[str, Any] = {}
...
def environment_input(
    ...
    features: Union[Optional[Iterable[DeviceFeature]], UnsetType] = UNSET,
) -> EnvironmentInput:
...
def flavour_filter(
    and_: Union[Optional[FlavourFilter], UnsetType] = UNSET,
    or_: Union[Optional[FlavourFilter], UnsetType] = UNSET,
    not_: Union[Optional[FlavourFilter], UnsetType] = UNSET,
    distinct: Union[Optional[bool], UnsetType] = UNSET,
    ids: Union[Optional[Iterable[IDCoercible]], UnsetType] = UNSET,
    search: Union[Optional[str], UnsetType] = UNSET,
    has_definitions: Union[Optional[Iterable[IDCoercible]], UnsetType] = UNSET,
) -> FlavourFilter:
...
def flavour_order(
    released_at: Union[Optional[Ordering], UnsetType] = UNSET,
) -> FlavourOrder:
...
def implementation_input(
    definition: DefinitionInput,
    dependencies: Iterable[AgentDependencyInput],
    dynamic: bool,
    needs_token: bool,
    optimistics: Union[Optional[Iterable[OptimisticInput]], UnsetType] = UNSET,
    tracks: Union[Optional[Iterable[TrackInput]], UnsetType] = UNSET,
    interface: Union[Optional[str], UnsetType] = UNSET,
    params: Union[Optional[Any], UnsetType] = UNSET,
    logo: Union[Optional[str], UnsetType] = UNSET,
    locks: Union[Optional[Iterable[str]], UnsetType] = UNSET,
    manipulates: Union[Optional[Iterable[str]], UnsetType] = UNSET,
    provenance_audience: Union[Optional[Iterable[str]], UnsetType] = UNSET,
) -> ImplementationInput:
    """Creates a ImplementationInput

    Arguments:
        optimistics: The optimistics of the definition. This is used to optimistically set state values when the action is assigned. This is used to provide a better user experience by optimistically setting state
        ...
        create a dependency graph for your implementations and actions (required) (list) (required)
        tracks: A value that is being tracked over time during the runtime of an action. This is the state of a dependency (required) (list)
        ...
        params: The `ArrayLike` scalar type represents a reference to a store previously created by the user n a datalayer
        dynamic: The `Boolean` scalar type represents `true` or `false`. (required)
        ...
        locks: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required) (list)
        manipulates: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required) (list)
        needs_token: The `Boolean` scalar type represents `true` or `false`. (required)
        provenance_audience: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required) (list)
    """
    data: Dict[str, Any] = {}
...
def inspection_input(
    locks: Iterable[LockImplementationInput],
    implementations: Iterable[ImplementationInput],
    states: Iterable[StateImplementationInput],
    bloks: Iterable[BlokImplementationInput],
...
def lock_definition_input(
    key: str, description: Union[Optional[str], UnsetType] = UNSET
) -> LockDefinitionInput:
...
def lock_implementation_input(
    key: str, definition: LockDefinitionInput
) -> LockImplementationInput:
    """Creates a LockImplementationInput

    Arguments:
        key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        definition: Which locks does the agent provide in general (required)
    """
    data: Dict[str, Any] = {}
    data["key"] = key
    data["definition"] = definition
...
def manifest_input(
    ...
    author: str,
    scopes: Iterable[str],
    entrypoint: Union[Optional[str], UnsetType] = UNSET,
    logo: Union[Optional[str], UnsetType] = UNSET,
) -> ManifestInput:
...
def optimistic_input(
    state: str, path: str, accessor: Union[Optional[str], UnsetType] = UNSET
) -> OptimisticInput:
    ...
    Arguments:
        ...
        path: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        accessor: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
    """
    data: Dict[str, Any] = {}
    data["state"] = state
    data["path"] = path
...
def port_group_input(
    ...
    description: Union[Optional[str], UnsetType] = UNSET,
    effects: Union[Optional[Iterable[EffectInput]], UnsetType] = UNSET,
    ports: Union[Optional[Iterable[str]], UnsetType] = UNSET,
) -> PortGroupInput:
...
def port_match_input(
    at: Union[Optional[int], UnsetType] = UNSET,
    key: Union[Optional[str], UnsetType] = UNSET,
    kind: Union[Optional[PortKind], UnsetType] = UNSET,
    identifier: Union[Optional[str], UnsetType] = UNSET,
    nullable: Union[Optional[bool], UnsetType] = UNSET,
    children: Union[Optional[Iterable[PortMatchInput]], UnsetType] = UNSET,
) -> PortMatchInput:
    """Creates a PortMatchInput

    Arguments:
        at: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
        key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        kind: PortKind
        identifier: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        nullable: The `Boolean` scalar type represents `true` or `false`.
        children: A dependency for a implementation. By defining dependencies, you can
        create a dependency graph for your implementations and actions (required) (list)
    """
    data: Dict[str, Any] = {}
    if at is not UNSET:
...
def provides_input(key: str, operator: ProvidesOperator, value: Any) -> ProvidesInput:
    ...
    Arguments:
        key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        operator: ProvidesOperator (required)
        value: The `Arg` scalar type represents a an Argument in a Action assignment (required)
    """
    data: Dict[str, Any] = {}
    data["key"] = key
...
def requires_input(key: str, operator: RequiresOperator, value: Any) -> RequiresInput:
    ...
    Arguments:
        key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        operator: RequiresOperator (required)
        value: The `Arg` scalar type represents a an Argument in a Action assignment (required)
    """
    data: Dict[str, Any] = {}
    data["key"] = key
...
def resource_filter(
    and_: Union[Optional[ResourceFilter], UnsetType] = UNSET,
    or_: Union[Optional[ResourceFilter], UnsetType] = UNSET,
    not_: Union[Optional[ResourceFilter], UnsetType] = UNSET,
    distinct: Union[Optional[bool], UnsetType] = UNSET,
    ids: Union[Optional[Iterable[IDCoercible]], UnsetType] = UNSET,
    search: Union[Optional[str], UnsetType] = UNSET,
) -> ResourceFilter:
...
def return_port_input(
    ...
    default: Union[Optional[Any], UnsetType] = UNSET,
    choices: Union[Optional[Iterable[ChoiceInput]], UnsetType] = UNSET,
    widget: Union[Optional[ReturnWidgetInput], UnsetType] = UNSET,
    provides: Union[Optional[Iterable[ProvidesInput]], UnsetType] = UNSET,
    children: Union[Optional[Iterable[ReturnPortInput]], UnsetType] = UNSET,
) -> ReturnPortInput:
    ...
    that is displayed when the user hovers over the choice.
         ...
         (required) (list)
        widget: A Return Widget is a UI element that is used to display the value of a port.
...
def return_widget_input(
    kind: ReturnWidgetKind,
    query: Union[Optional[SearchQuery], UnsetType] = UNSET,
    choices: Union[Optional[Iterable[ChoiceInput]], UnsetType] = UNSET,
    min: Union[Optional[int], UnsetType] = UNSET,
    max: Union[Optional[int], UnsetType] = UNSET,
    step: Union[Optional[int], UnsetType] = UNSET,
    placeholder: Union[Optional[str], UnsetType] = UNSET,
    hook: Union[Optional[str], UnsetType] = UNSET,
    ward: Union[Optional[str], UnsetType] = UNSET,
) -> ReturnWidgetInput:
    ...
    Arguments:
        kind: ReturnWidgetKind (required)
        query: The `ArrayLike` scalar type represents a reference to a store previously created by the user n a datalayer
        choices:
    A choice is a value that can be selected in a dropdown.
    ...
    that is displayed when the user hovers over the choice.
         ...
         (required) (list)
        min: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
        max: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
        step: The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.
        placeholder: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        hook: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        ward: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
    """
...
def selector_input(
    kind: str,
    api_version: Union[Optional[str], UnsetType] = UNSET,
    api_thing: Union[Optional[str], UnsetType] = UNSET,
    oneapi_version: Union[Optional[str], UnsetType] = UNSET,
    cuda_cores: Union[Optional[int], UnsetType] = UNSET,
    frequency: Union[Optional[int], UnsetType] = UNSET,
    memory: Union[Optional[int], UnsetType] = UNSET,
) -> SelectorInput:
...
def state_accessor_input(
    option_key: OptionKey, sub_path: Union[Optional[str], UnsetType] = UNSET
) -> StateAccessorInput:
    """Creates a StateAccessorInput

    Arguments:
        option_key: OptionKey (required)
        sub_path: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
    """
    data: Dict[str, Any] = {}
...
def state_definition_input(
    ports: Iterable[ReturnPortInput], name: str
...
def state_dependency_input(
    key: str,
    optional: bool,
    name: Union[Optional[str], UnsetType] = UNSET,
    protocols: Union[Optional[Iterable[IDCoercible]], UnsetType] = UNSET,
    description: Union[Optional[str], UnsetType] = UNSET,
    state_key: Union[Optional[str], UnsetType] = UNSET,
    app: Union[Optional[str], UnsetType] = UNSET,
    port_matches: Union[Optional[Iterable[PortMatchInput]], UnsetType] = UNSET,
    allow_inactive: Union[Optional[bool], UnsetType] = UNSET,
) -> StateDependencyInput:
    """Creates a StateDependencyInput

    Arguments:
        name: The name of the state. This is used to identify the action in the system.
        ...
        app: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        port_matches: A dependency for a implementation. By defining dependencies, you can
        create a dependency graph for your implementations and actions (required) (list)
        optional: The `Boolean` scalar type represents `true` or `false`. (required)
        allow_inactive: The `Boolean` scalar type represents `true` or `false`.
    """
...
def state_implementation_input(
    interface: str, definition: StateDefinitionInput
    ...
    Arguments:
        ...
        definition: A state schema is a blueprint for a state. It is composed of a definition, a list of dependencies, and a list of params. (required)
    """
    data: Dict[str, Any] = {}
    data["interface"] = interface
    data["definition"] = definition
...
def track_input(
    state_key: str,
    value_key: str,
    dependency_key: Union[Optional[str], UnsetType] = UNSET,
    label: Union[Optional[str], UnsetType] = UNSET,
    description: Union[Optional[str], UnsetType] = UNSET,
    windows: Union[Optional[Iterable[WindowInput]], UnsetType] = UNSET,
) -> TrackInput:
    """Creates a TrackInput

    Arguments:
        dependency_key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        state_key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        value_key: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        label: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        description: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        windows: A window that is calculated (required) (list)
    """
    data: Dict[str, Any] = {}
...
def update_pod_input(
    status: PodStatus,
    pod: Union[Optional[IDCoercible], UnsetType] = UNSET,
    local_id: Union[Optional[IDCoercible], UnsetType] = UNSET,
) -> UpdatePodInput:
...
def validator_input(
    ...
    Arguments:
        ...
        dependencies: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required) (list)
        label: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
        error_message: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
    """
    data: Dict[str, Any] = {}
    data["function"] = function
    if dependencies is not UNSET:
...
def window_input(
    window_function: str, label: Union[Optional[str], UnsetType] = UNSET
) -> WindowInput:
    """Creates a WindowInput

    Arguments:
        window_function: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. (required)
        label: The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.
    """
    data: Dict[str, Any] = {}
...
async def adeclare_backend(
    name: str, kind: str, rath: Optional[KabinetRath] = None
) -> Backend:
    """DeclareBackend
    ...
    return (
        await aexecute(DeclareBackendMutation, variables, rath=rath)
    ).declare_backend
...
async def acreate_deployment(
    ...
    variables["input"] = _input
    return (
        await aexecute(CreateDeploymentMutation, variables, rath=rath)
    ).create_deployment
...
async def acreate_app_image(
    ...
    variables["input"] = _input
    return (
        await aexecute(CreateAppImageMutation, variables, rath=rath)
    ).create_app_image
...
async def acreate_github_repo(
    ...
    variables["input"] = _input
    return (
        await aexecute(CreateGithubRepoMutation, variables, rath=rath)
    ).create_github_repo
...
async def adeclare_resource(
    ...
    variables["input"] = _input
    return (
        await aexecute(DeclareResourceMutation, variables, rath=rath)
    ).declare_resource
...
async def alist_backends(
    filters: Union[Optional[BackendFilter], UnsetType] = UNSET,
...
async def amatch_flavour(
    actions: Union[Optional[List[ActionHash]], UnsetType] = UNSET,
    environment: Union[Optional[EnvironmentInput], UnsetType] = UNSET,
    rath: Optional[KabinetRath] = None,
...
async def alist_flavours(
    filters: Union[Optional[FlavourFilter], UnsetType] = UNSET,
    pagination: Union[Optional[OffsetPaginationInput], UnsetType] = UNSET,
    ordering: Union[Optional[List[FlavourOrder]], UnsetType] = UNSET,
    rath: Optional[KabinetRath] = None,
) -> Tuple[ListFlavour, ...]:
    """ListFlavours
...
async def asearch_pods(
    search: Union[Optional[str], UnsetType] = UNSET,
    values: Union[Optional[List[ID]], UnsetType] = UNSET,
    backend: Union[Optional[ID], UnsetType] = UNSET,
    rath: Optional[KabinetRath] = None,
...
async def alist_resources(
    filters: Union[Optional[ResourceFilter], UnsetType] = UNSET,
    pagination: Union[Optional[OffsetPaginationInput], UnsetType] = UNSET,
    rath: Optional[KabinetRath] = None,
) -> Tuple[ListResource, ...]:
    """ListResources
