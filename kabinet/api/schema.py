...
"""
    ...
    if value_literal is not UNSET:
        _data['valueLiteral'] = value_literal
    if value_path is not UNSET:
        _data['valuePath'] = value_path
    if agent_call is not UNSET:
        _data['agentCall'] = agent_call
    if util_call is not UNSET:
        _data['utilCall'] = util_call
    if value_list is not UNSET:
        _data['valueList'] = value_list
    if value_dict is not UNSET:
        _data['valueDict'] = value_dict
    return ActionArgumentInput.model_validate(_data)
...
"""
    ...
    if arg_matches is not UNSET:
        _data['argMatches'] = arg_matches
    if return_matches is not UNSET:
        _data['returnMatches'] = return_matches
    if protocols is not UNSET:
        _data['protocols'] = protocols
    if force_arg_length is not UNSET:
        _data['forceArgLength'] = force_arg_length
    if force_return_length is not UNSET:
        _data['forceReturnLength'] = force_return_length
    if pure is not UNSET:
        _data['pure'] = pure
    if idempotent is not UNSET:
        _data['idempotent'] = idempotent
    if stateful is not UNSET:
        _data['stateful'] = stateful
    return ActionDemandInput.model_validate(_data)
...
"""
    ...
    if allow_inactive is not UNSET:
        _data['allowInactive'] = allow_inactive
    return ActionDependencyInput.model_validate(_data)
...
"""
    ...
    if action_dependencies is not UNSET:
        _data['actionDependencies'] = action_dependencies
    if state_dependencies is not UNSET:
        _data['stateDependencies'] = state_dependencies
    _data['autoResolvable'] = auto_resolvable
    if mutually_exclusive_keys is not UNSET:
        _data['mutuallyExclusiveKeys'] = mutually_exclusive_keys
    if min_viable_instances is not UNSET:
        _data['minViableInstances'] = min_viable_instances
    if max_viable_instances is not UNSET:
        _data['maxViableInstances'] = max_viable_instances
    if prefered_instances is not UNSET:
        _data['preferedInstances'] = prefered_instances
    _data['assignPolicy'] = assign_policy
    return AgentDependencyInput.model_validate(_data)
...
"""
    _data: dict[str, builtins.object] = {}
    _data['dependency'] = dependency
    _data['operation'] = operation
    if arguments is not UNSET:
        _data['arguments'] = arguments
    return AgentProbeInput.model_validate(_data)
...
"""
    ...
    if flavour_name is not UNSET:
        _data['flavourName'] = flavour_name
    _data['manifest'] = manifest
    _data['selectors'] = selectors
    _data['appImageId'] = app_image_id
    _data['inspection'] = inspection
    _data['image'] = image
...
"""
    ...
    return ArgPortInput.model_validate(_data)
...
"""
    ...
    if follow_value is not UNSET:
        _data['followValue'] = follow_value
    if min is not UNSET:
        _data['min'] = min
    if max is not UNSET:
        _data['max'] = max
    ...
    if as_paragraph is not UNSET:
        _data['asParagraph'] = as_paragraph
    ...
    if state_path is not UNSET:
        _data['statePath'] = state_path
    if state_call is not UNSET:
        _data['stateCall'] = state_call
    if state_accessors is not UNSET:
        _data['stateAccessors'] = state_accessors
    if target_port is not UNSET:
        _data['targetPort'] = target_port
    if target_action is not UNSET:
        _data['targetAction'] = target_action
    if target_dependency is not UNSET:
        _data['targetDependency'] = target_dependency
    return TypeAdapter(AssignWidgetInput).validate_python(_data)
...
"""
    ...
    if search is not UNSET:
        _data['search'] = search
    return BackendFilter.model_validate(_data)
...
"""
    ...
    if demo_state is not UNSET:
        _data['demoState'] = demo_state
    return BlokImplementationInput.model_validate(_data)
...
"""
    ...
    if description is not UNSET:
        _data['description'] = description
    return ChoiceInput.model_validate(_data)
...
"""
    ...
    if children is not UNSET:
        _data['children'] = children
    return ComponentNodeInput.model_validate(_data)
...
"""
    ...
    if static_value is not UNSET:
        _data['staticValue'] = static_value
    if dynamic_value is not UNSET:
        _data['dynamicValue'] = dynamic_value
    if declares_value is not UNSET:
        _data['declaresValue'] = declares_value
    if agent_call is not UNSET:
        _data['agentCall'] = agent_call
    if util_call is not UNSET:
        _data['utilCall'] = util_call
...
"""
    ...
    if secret_params is not UNSET:
        _data['secretParams'] = secret_params
    return CreateDeploymentInput.model_validate(_data)
...
"""
    ...
    if auto_scan is not UNSET:
        _data['autoScan'] = auto_scan
    return CreateGithubRepoInput.model_validate(_data)
...
"""
    _data: dict[str, builtins.object] = {}
    _data['deployment'] = deployment
    _data['localId'] = local_id
    if resource is not UNSET:
        _data['resource'] = resource
    if client_id is not UNSET:
        _data['clientId'] = client_id
    return CreatePodInput.model_validate(_data)
...
"""
    ...
    _data['name'] = name
    _data['kind'] = kind
    return DeclareBackendInput.model_validate(_data)
...
"""
    ...
    if qualifiers is not UNSET:
        _data['qualifiers'] = qualifiers
    return DeclareResourceInput.model_validate(_data)
...
"""
    ...
    _data['pure'] = pure
    _data['idempotent'] = idempotent
    _data['allowProbe'] = allow_probe
    if catalogs is not UNSET:
        _data['catalogs'] = catalogs
    _data['portGroups'] = port_groups
    _data['args'] = args
    _data['returns'] = returns
    _data['kind'] = kind
    _data['isTestFor'] = is_test_for
    _data['isDev'] = is_dev
    return DefinitionInput.model_validate(_data)
...
"""
    _data: dict[str, builtins.object] = {}
    _data['id'] = id
    return DeletePodInput.model_validate(_data)
...
"""
    ...
    _data['key'] = key
    _data['value'] = value
    return DescriptorInput.model_validate(_data)
...
"""
    _data: dict[str, builtins.object] = {}
    _data['imageString'] = image_string
    _data['buildAt'] = build_at
    return DockerImageInput.model_validate(_data)
...
"""
    ...
    _data['pod'] = pod
    _data['logs'] = logs
    return DumpLogsInput.model_validate(_data)
...
"""
    ...
    if path is not UNSET:
        _data['path'] = path
    return DynamicValueInput.model_validate(_data)
...
"""
    ...
    if source is not UNSET:
        _data['source'] = source
    return EffectInput.model_validate(_data)
...
"""
    ...
    if has_definitions is not UNSET:
        _data['hasDefinitions'] = has_definitions
    return FlavourFilter.model_validate(_data)
...
"""
    ...
    if released_at is not UNSET:
        _data['releasedAt'] = released_at
    return FlavourOrder.model_validate(_data)
...
"""
    ...
    if interface is not UNSET:
        _data['interface'] = interface
    if params is not UNSET:
        _data['params'] = params
    if instance_id is not UNSET:
        _data['instanceId'] = instance_id
    if locks is not UNSET:
        _data['locks'] = locks
    if optimistics is not UNSET:
        _data['optimistics'] = optimistics
    if manipulates is not UNSET:
        _data['manipulates'] = manipulates
    _data['needsToken'] = needs_token
    if provenance_audience is not UNSET:
        _data['provenanceAudience'] = provenance_audience
    _data['effect'] = effect
...
"""
    ...
    if size is not UNSET:
        _data['size'] = size
    _data['locks'] = locks
    _data['implementations'] = implementations
    _data['states'] = states
    _data['bloks'] = bloks
    _data['requirements'] = requirements
    return InspectionInput.model_validate(_data)
...
"""
    ...
    if description is not UNSET:
        _data['description'] = description
    return LockDefinitionInput.model_validate(_data)
...
"""
    ...
    if limit is not UNSET:
        _data['limit'] = limit
    return OffsetPaginationInput.model_validate(_data)
...
"""
    ...
    if path_call is not UNSET:
        _data['pathCall'] = path_call
    if accessor is not UNSET:
        _data['accessor'] = accessor
    return OptimisticInput.model_validate(_data)
...
"""
    ...
    if effects is not UNSET:
        _data['effects'] = effects
    _data['ports'] = ports
    return PortGroupInput.model_validate(_data)
...
"""
    ...
    if descriptors is not UNSET:
        _data['descriptors'] = descriptors
    if children is not UNSET:
        _data['children'] = children
    return PortMatchInput.model_validate(_data)
...
"""
    ...
    if value is not UNSET:
        _data['value'] = value
    return ProvidesInput.model_validate(_data)
...
"""
    ...
    _data['key'] = key
    _data['value'] = value
    return QualifierInput.model_validate(_data)
...
"""
    ...
    if description is not UNSET:
        _data['description'] = description
    return RequirementInput.model_validate(_data)
...
"""
    ...
    if value is not UNSET:
        _data['value'] = value
    return RequiresInput.model_validate(_data)
...
"""
    ...
    if search is not UNSET:
        _data['search'] = search
    return ResourceFilter.model_validate(_data)
...
"""
    ...
    if provides is not UNSET:
        _data['provides'] = provides
    return ReturnPortInput.model_validate(_data)
...
"""
    ...
    if props is not UNSET:
        _data['props'] = props
    return TypeAdapter(ReturnWidgetInput).validate_python(_data)
...
"""
    ...
    if compute_capability is not UNSET:
        _data['computeCapability'] = compute_capability
    if cuda_version is not UNSET:
        _data['cudaVersion'] = cuda_version
    if memory is not UNSET:
        _data['memory'] = memory
    if count is not UNSET:
        _data['count'] = count
    if cuda_cores is not UNSET:
        _data['cudaCores'] = cuda_cores
    if api_version is not UNSET:
        _data['apiVersion'] = api_version
    if api_thing is not UNSET:
        _data['apiThing'] = api_thing
    if oneapi_version is not UNSET:
        _data['oneapiVersion'] = oneapi_version
    if key is not UNSET:
        _data['key'] = key
    if value is not UNSET:
        _data['value'] = value
    return TypeAdapter(SelectorInput).validate_python(_data)
...
"""
    _data: dict[str, builtins.object] = {}
    _data['optionKey'] = option_key
    if path is not UNSET:
        _data['path'] = path
    if call is not UNSET:
        _data['call'] = call
    return StateAccessorInput.model_validate(_data)
...
"""
    ...
    _data['ports'] = ports
    _data['name'] = name
    return StateDefinitionInput.model_validate(_data)
...
"""
    ...
    if protocols is not UNSET:
        _data['protocols'] = protocols
    return StateDemandInput.model_validate(_data)
...
"""
    ...
    if allow_inactive is not UNSET:
        _data['allowInactive'] = allow_inactive
    return StateDependencyInput.model_validate(_data)
...
"""
    ...
    if app is not UNSET:
        _data['app'] = app
    _data['definition'] = definition
    return StateImplementationInput.model_validate(_data)
...
"""
    ...
    if version is not UNSET:
        _data['version'] = version
    return TestTargetInput.model_validate(_data)
...
"""
    ...
    if dependency_key is not UNSET:
        _data['dependencyKey'] = dependency_key
    _data['stateKey'] = state_key
    _data['valueKey'] = value_key
    if label is not UNSET:
        _data['label'] = label
    if description is not UNSET:
        _data['description'] = description
    if windows is not UNSET:
        _data['windows'] = windows
    return TrackInput.model_validate(_data)
...
"""
    ...
    if local_id is not UNSET:
        _data['localId'] = local_id
    _data['status'] = status
    return UpdatePodInput.model_validate(_data)
...
"""
    ...
    if arguments is not UNSET:
        _data['arguments'] = arguments
    return UtilCallInput.model_validate(_data)
...
"""
    ...
    if error_message is not UNSET:
        _data['errorMessage'] = error_message
    if source is not UNSET:
        _data['source'] = source
    return ValidatorInput.model_validate(_data)
...
"""
    _data: dict[str, builtins.object] = {}
    _data['windowFunction'] = window_function
    if label is not UNSET:
        _data['label'] = label
    return WindowInput.model_validate(_data)
